...
@section('content')
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">Ajouter Produit Chimique</h3>
                    @can('view-'.str_slug('ProduitChimique'))
                    <a  class="btn btn-success pull-right" href="{{url('/produitsChimique/produit-chimique')}}"><i class="icon-arrow-left-circle"></i> Liste Produit Chimique</a>
                    @endcan
                    ...
                    <form method="POST" action="{{ url('/produitsChimique/produit-chimique') }}" accept-charset="UTF-8"
                          class="form-horizontal" enctype="multipart/form-data">
                        {{ csrf_field() }}

                        @include ('produit-chimique.form')
                    </form>
                </div>
            </div>
        </div>
