...
<section id="wrapper" class="login-register">
    <div class="login-box">
        ...
        <div class="white-box">
                <center><h2 class="title">LabMan <strong> Systems</strong></h2></center>
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        <div class="checkbox checkbox-primary pull-left p-t-0">
                            ...
                            <label for="checkbox-signup"> Resté connecté </label>
                        </div>
                        <a href="{{ route('password.request') }}" id="to-recover" class="text-dark pull-right"><i class="fa fa-lock m-r-5"></i> Mdp Oulié ?</a> </div>
                </div>
