<div class="form-group {{ $errors->has('designation') ? 'has-error' : ''}}">
    ...
    <div class="col-md-6">
        <input class="form-control" name="date_fab" type="date" id="date_fab" value="{{ $reactif->date_fab or ''}}" required>
    ...
    <div class="col-md-6">
        <input class="form-control" name="date_exp" type="date" id="date_exp" value="{{ $reactif->date_exp or ''}}" required>
    ...
    <div class="col-md-6">
        <input class="form-control" name="user_id" type="number" id="user_id" value="{{ $reactif->user_id or ''}}" required>
