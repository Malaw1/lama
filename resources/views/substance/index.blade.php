                ...
                <div class="white-box">
                    ...
                    @can('add-'.str_slug('Substance'))
                        <a class="btn btn-success pull-right" href="{{ url('/substance/substance/create') }}"><i
                                    class="icon-plus"></i> Add Substance</a>
                    @endcan
                    ...
                    <div class="table-responsive">
                        <table class="table table-borderless" id="myTable">
                            ...
                            <tr>
                                <th>#</th>
                                <th>Designation</th><th>Quantite</th><th>Date Fab</th>
                                <th>Actions</th>
                            </tr>
                            </thead>
                            <tbody>
                            @foreach($substance as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->designation }}</td><td>{{ $item->quantite }}</td><td>{{ $item->date_fab }}</td>
                                    <td>
                                        ...
                                        @can('delete-'.str_slug('Substance'))
                                            {!! Form::open([
                                       'method'=>'DELETE',
                                       'url' => ['/substance/substance', $item->id],
