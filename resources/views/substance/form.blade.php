...
<div class="form-group {{ $errors->has('quantite') ? 'has-error' : ''}}">
    ...
    <div class="col-md-3">
        <input class="form-control" name="unite" type="text" id="unite" value="{{ $substance->unite or ''}}" required>
        {!! $errors->first('quantite', '<p class="help-block">:message</p>') !!}
    </div>
</div>
...
<div class="form-group {{ $errors->has('fabricant') ? 'has-error' : ''}}">
    ...
    <div class="col-md-6">
        <input class="form-control" name="date_fab" type="date" id="date_fab" value="{{ $substance->date_fab or ''}}" >
    ...
    <div class="col-md-6">
        <input class="form-control" name="date_exp" type="date" id="date_exp" value="{{ $substance->date_exp or ''}}" >
...
<div class="form-group {{ $errors->has('prix') ? 'has-error' : ''}}">
    <label for="prix" class="col-md-4 control-label">{{ 'Certificat' }}</label>
    <div class="col-md-6">
        <input class="form-control" name="certificat" type="text" id="stockage" value="{{ $substance->certificat or ''}}"  >
        {!! $errors->first('prix', '<p class="help-block">:message</p>') !!}
    </div>
</div>
...
<div class="form-group {{ $errors->has('prix') ? 'has-error' : ''}}">
    ...
    <div class="col-md-6">
        <input class="form-control" name="stockage" type="text" id="stockage" value="{{ $substance->stockage or ''}}"  >
        {!! $errors->first('prix', '<p class="help-block">:message</p>') !!}
    </div>
</div>
