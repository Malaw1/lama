                ...
                <div class="white-box">
                    ...
                    <div class="table-responsive">
                        <table class="table table">
                            ...
                            <tr><th> Code </th><td> {{ $objetessai->code }} </td></tr><tr><th> Forme Galenique </th><td> {{ $objetessai->forme_galenique }} </td></tr><tr><th> Date Recue </th><td> {{ $objetessai->date_recue }} </td></tr>
                            </tbody>
                        </table>
                    </div>
                </div>
