                            ...
                            <div class="panel-body">
                                <form action="{{route('faisabilites.store')}}" method="POST">
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                            {{-- <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="objet" onchange="yesnoCheck(this);" class="form-control select2">
                                                        <option>Choisir</option>
                                                        @foreach($objet as $objet)
                                                            <option id="code" value="{{ $objet->code}}">{{ $objet->code}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div> --}}
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Objet d'Essai</label>
                                                        ...
                                                        <select name="objet" class="form-control select2" onchange="yesnoCheck(this);" id="form-field-select-3" data-placeholder="Choisir un type">
                                                            <option value=""> Choisir </option>
                                                            @foreach($objet as $objet)
                                                                <option id="code" value="{{ $objet->code}}">{{ $objet->code}}</option>
                                                            @endforeach
                                                            <option value="medicament"> Test </option>
                                                        </select>
                                        ...
                                        <div class="row">
                                            <div id="test" class="table" style="display: none">
                                                <table class="table table-striped">
                                                    <thead>
                                                        <tr>
                                                        <th scope="col" >#</th>
                                                        <th scope="col">Code Objet d'Essai</th>
                                                        <th scope="col">Lot</th>
                                                        <th scope="col"># Demande</th>
                                                        <th scope="col">Code Molecule</th>
                                                        <th scope="col">Peremption</th>
                                                        <th scope="col">Tests Demandes</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                         @foreach($dem as $dem)
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="param[]" class="select2 m-b-10 select2-multiple" multiple="multiple" data-placeholder="Choisir">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="methode[]" class="select2 m-b-10 select2-multiple" multiple="multiple" data-placeholder="Choisir">
