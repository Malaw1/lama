                ...
                <div class="white-box">
                    ...
                    <div class="table-responsive">
                        <table class="table table">
                            ...
                            <tr><th> Reference </th><td> {{ $faisabilite->reference }} </td></tr><tr><th> Objet Essai </th><td> {{ $faisabilite->objet_essai }} </td></tr><tr><th> Molecule </th><td> {{ $faisabilite->molecule }} </td></tr>
                            </tbody>
                        </table>
                    </div>
                </div>
