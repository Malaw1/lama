...
@section('content')
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">Nouvelle Faisabilite</h3>
                    @can('view-'.str_slug('Faisabilite'))
                        <a class="btn btn-success pull-right" href="{{url('/faisabilite/faisabilite')}}">
                            <i class="icon-arrow-left-circle"></i> Voire Faisabilite</a>
                    @endcan
                    ...
                    {!! Form::open(['url' => '/faisabilite/faisabilite', 'class' => 'form-horizontal', 'files' => true]) !!}
