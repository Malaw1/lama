                ...
                <div class="white-box">
                    ...
                    <div class="table-responsive">
                        <table class="table" id="myTable">
                            ...
                            <tr>
                                <th>#</th>
                                <th>Equipement</th><th>Date Calib</th><th>Next Calib</th>
                                <th>Actions</th>
                            </tr>
                            </thead>
                            <tbody>
                            @foreach($eqqualif as $item)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @can('edit-'.str_slug('EqQualif'))
                                            <a href="{{ url('/eq-qualif/eq-qualif/' . $item->id . '/edit') }}"
                                               title="Edit EqQualif">
                                        ...
                                        @can('delete-'.str_slug('EqQualif'))
                                            <form method="POST"
                                                  action="{{ url('/eq-qualif/eq-qualif' . '/' . $item->id) }}"
                                                  accept-charset="UTF-8" style="display:inline">
                                                {{ method_field('DELETE') }}
                                                {{ csrf_field() }}
                                                <button type="submit" class="btn btn-danger btn-sm"
                                                        title="Delete EqQualif"
                        ...
                        <div class="pagination-wrapper"> {!! $eqqualif->appends(['search' => Request::get('search')])->render() !!} </div>
                    </div>
                </div>
            </div>
        </div>
