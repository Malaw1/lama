                ...
                <div class="white-box">
                    ...
                    <div class="table-responsive">
                        <table class="table" id="myTable">
                            ...
                            <tr>
                                <th>#</th>
                                <th>Designation</th><th>Code</th><th>Dci</th>
                                <th>Actions</th>
                            </tr>
                            </thead>
                            <tbody>
                            @foreach($screening as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->designation }}</td><td>{{ $item->code }}</td><td>{{ $item->dci }}</td>
                                    <td>
                        ...
                        <div class="pagination-wrapper"> {!! $screening->appends(['search' => Request::get('search')])->render() !!} </div>
                    </div>
                </div>
            </div>
        </div>
