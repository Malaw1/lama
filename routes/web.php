...
Route::resource('produitsChimique/produit-chimique', 'Admin\\ProduitChimiqueController');
Route::resource('consommable/consommable', 'consommable\\ConsommableController');
Route::resource('client/client', 'Admin\\ClientController');

Route::resource('demande/demande', 'Admin\\DemandeController');

Route::resource('equipement/equipement', 'Admin\\EquipementController');
...
Route::resource('pharmacopee/pharmacopee', 'Admin\\PharmacopeeController');
