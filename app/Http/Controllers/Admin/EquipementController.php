...
class EquipementController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if(auth()->user()->permissions()->where('name','=','view-'.$model)->first()!= null) {
            ...
            if (!empty($keyword)) {
                ...
                ->orWhere('date_install', 'LIKE', "%$keyword%")
    ...
    public function store(Request $request)
    {
        ...
        if(auth()->user()->permissions()->where('name','=','add-'.$model)->first()!= null) {
            ...
            return redirect('equipment/equipement')->with('flash_message', 'Equipement added!');
        }
        return response(view('403'), 403);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if(auth()->user()->permissions()->where('name','=','edit-'.$model)->first()!= null) {
            ...
            $equipement = Equipement::findOrFail($id);
             ...
             return redirect('equipment/equipement')->with('flash_message', 'Equipement updated!');
        }
        return response(view('403'), 403);
    ...
    public function destroy($id)
    {
        ...
        if(auth()->user()->permissions()->where('name','=','delete-'.$model)->first()!= null) {
            ...
            return redirect('equipment/equipement')->with('flash_message', 'Equipement deleted!');
        }
        return response(view('403'), 403);
